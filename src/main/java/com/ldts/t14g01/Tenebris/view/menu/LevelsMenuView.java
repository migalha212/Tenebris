...
public class LevelsMenuView extends View<Menu> {
    ...
    protected void drawElements(GUI gui) throws IOException {
        ...
        if (this.getModel().getOptions() == null) {
            gui.drawText("You have no saves to reference, how are you here?", new Vector2D(centerX, centerY), GUI.Colors.WHITE, GUI.Colors.BLACK);
        } else {
            ...
            gui.drawText(difficultyref, new Vector2D(gui.getWindowSize().x() - 4 - difficultyref.length() - difficulty.length(), centerY - 7), GUI.Colors.WHITE, GUI.Colors.BLACK);
            ...
            gui.drawText(difficulty, new Vector2D(gui.getWindowSize().x() - 4 - difficulty.length(), centerY - 7), foreGroundColor, GUI.Colors.BLACK);
            ...
            gui.drawText("Level " + i,new Vector2D(offsetX,centerY + i - 3), foreGroundColor, GUI.Colors.BLACK);
            }
        }
    }
}
